...
<head>
    ...
    <link href="{{ asset('css/lib/einvoice/boxicons.min.css') }}" rel="stylesheet">
    
    <!--Bootstrap CDN Link-->
    <!--link href="{{ asset('https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css')}}" rel="stylesheet" integrity="sha384-EVSTQN3/azprG1Anm3QDgpJLIm9Nao0Yz1ztcQTwFspd3yD65VohhpuuCOmLASjC" crossorigin="anonymous"-->
    
    <link href="{{ asset('css/lib/einvoice/bootstrap.min.css') }}" rel="stylesheet">
    <!--Font Family Link-->
    ...
    <section class="tex_invoice_area">
        <div class="container">
            <div class="main_table row">
               <div class="heading">
                   <h4>{{ $einvoiceHeaderDTO->getVatRate() == 0? 'Sales Invoice' : 'Simpilified Tax Invoice' }} <span style="padding-left: 12px;">{{$einvoiceHeaderDTO->getVatRate() == 0? 'فاتورة مبيعات' : 'فاتورة ضريبية مبسطة' }}</span></h4>
               </div>
...
<!--                        <tr>
                            <td class="padding_left border_two">Company VAT No.</td>
                            <td style="padding-left: 10%;">{{$einvoiceHeaderDTO->getCompanyVatNo()}}</td>
                            <td class="padding_left" style="text-align: right; font-family: 'GE Elegant';">الرقم الضريبى للشركة</td>
                        </tr>-->
                        <tr>
                        ...
                        @if($einvoiceHeaderDTO->getVatRate() != 0)
                        <tr>
                            <td class="padding_left border_two">VAT Rate</td>
                            <td style="padding-left: 10%;">{{$einvoiceHeaderDTO->getVatRate() * 100 }}%</td>
                            <td class="padding_left" style="text-align: right; font-family: 'GE Elegant';">نسبة الضريبة</td>
                        </tr>
                        @endif
                        
                        @if($einvoiceHeaderDTO->getTotalDiscount() != 0)
                        <tr>
                        ...
                        <tr>
                            ...
                            <td style="padding-left: 10%;">{{$einvoiceHeaderDTO->getTotalWithTax()}} SAR</td>
...
<!--                        <img src="{{ asset('css/images/qr.png') }}" alt="qr">
    ...
    <script src="{{ asset('css/lib/einvoice/boxicons.js') }}"></script>
    
    <!--Bootstrap CDN js-->
    <!--script src="{{ asset('https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js')}}" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script-->
    
    <script src="{{ asset('css/lib/einvoice/bootstrap.bundle.min.js') }}"></script>
</body></html>
