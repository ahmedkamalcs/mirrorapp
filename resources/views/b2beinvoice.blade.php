        ...
        <div class="container">
            <div class="row">
                ...
                <div class="company_details col-lg-6 col-md-9 col-12">
                    <!--======copy item=====-->
                     @if($einvoiceHeaderDTO->getCreditNote() == '1')
                    <div class="row">
                        <div class="company_details_left col-lg-6 col-6">
                            <p>Credit Note: </p>
                            <span style="font-family: 'GE Elegant';">رقم الاشعار</span>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="company_details_right col-lg-6 col-6">
                            <p>{{$einvoiceHeaderDTO->getInvoiceNumber()}}</p>
                        </div>
                    </div>
                    <!--======copy item=====-->
                    <div class="row">
    ...
    <section class="tex_invoice_area">
        <div class="container">
            <div class="main_table row">
               <div class="heading">
                   <h4>{{ $einvoiceHeaderDTO->getVatRate() == 0? 'Sales Invoice' : 'Tax Invoice' }} <span style="padding-left: 12px;">{{$einvoiceHeaderDTO->getVatRate() == 0? 'فاتورة مبيعات' : 'فاتورة ضريبية' }}</span></h4>
               </div>
