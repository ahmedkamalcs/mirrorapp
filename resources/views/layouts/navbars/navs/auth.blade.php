...
<div class="container-fluid position-absolute bg-white  p-0">
        ...
        <nav class="navbar navbar-light">
            ...
            <div class="navbar-nav w-100">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="{{ route('itemmaster')  }}" class="dropdown-item">Item Master</a>
                        <a href="{{ route('servicemaster')  }}" class="dropdown-item">Service Items</a>
                        <a href="{{ route('vendormaster')  }}" class="dropdown-item">Vendor Master</a>
                        <!--a href="#"  onclick="alert('Under Development')" class="dropdown-item">Item Vendor</a-->
                        <a href="{{ route('customermasterb2b')  }}" class="dropdown-item">B2B Customer Master</a>
                        <a href="{{ route('customermasterb2c')  }}" class="dropdown-item">B2C Customer Master</a>
                    </div>
                </div>
                <div class="line"></div>
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu bg-transparent border-0">
                        <a href="{{ route('companyprofile')  }}"  class="dropdown-item">Company Profile</a>
                        <!--a href="#" onclick="alert('Under Development')"  class="dropdown-item">Register User</a>
                        <a href="#"  onclick="alert('Under Development')" class="dropdown-item">Pages access</a-->
    ...
    <div class="content">
        ...
        <div id="abd">
            <div id="popupContact">
                <form action="#" id="form" name="form" class="form7">

                    <button id="close"  onclick ="log_hide2();return;" class="img1"><span class="material-symbols-outlined">
                            cancel
                        </span></button>
                    <hr>
                    <div class="container">
                        ...
                        <div class="span24">
                            <button class="btnreset" onclick="log_hide2();return;" >Cancel</button>
    ...
    <script src="{{ asset('css/lib/main/jquery3.js')}}"></script> 
    
    <!-- script src="https://code.jquery.com/jquery-3.4.1.min.js"></script -->
    <script src="{{ asset('css/lib/main/jquery4.js')}}"></script> 
    
    <script src="{{ asset('css/lib/main/bootstrap.bundle.min.js')}}"></script>
    <script src="{{ asset('css/lib/chart/chart.min.js')}}"></script>
    ...
    <!-- Template Javascript -->
    <script src="{{ asset('css/lib/main/main.js')}}"></script>
