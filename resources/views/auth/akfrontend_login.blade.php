@extends('layouts.app', ['class' => 'off-canvas-sidebar', 'activePage' => 'login', 'title' => __('E-Invoice System')])
...
<!--            <div class="bmd-form-group  mt-3">
              <div class="input-group">
                ...
                <select class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" id="companyprofileselect" name="companyprofileselect" >
