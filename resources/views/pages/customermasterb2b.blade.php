@extends('layouts.app')
@section('title', 'B2B. Customer Master')
@section('hubcontent')


<!--<div class="container first">
    <div class="firsthead">
        <div  ><a href="#" class="firsthead1" >B2B Customer Master</a> </div>
...
<!--    <div >
        <div ><a href="{{url("customermasterb2bwizard")}}" class="firsthead2">Wizard</a></div>
        <div class="headline4"> </div>
    </div>-->
...
<div class="container cont1 ">
    <button class="addbutton" disabled="true"><i class="fa-solid fa-plus icon"></i><a href="{{url("customermasterb2bwizard")}}">Add</a></button>
    ...
    <a href="{{ url('/download/B2B_Customer_Master_Data.xlsx')  }}" target="_blank" class="dawntbutton"><i class="fa-solid fa-download icon"></i>Downlaod</a>
    ...
    <div id="uploadform">
        ...
        <form class="uploadFileForm" action="{{url("importcustomerb2b")}}" method="post" enctype="multipart/form-data" >
            @csrf
    ...
    <table class=" table2 text-start table-hover  Customer_list data " id="customers-list" >
        <thead >
            <tr class="brd2">
                ...
                <th scope="col">Company Name AR</th>
