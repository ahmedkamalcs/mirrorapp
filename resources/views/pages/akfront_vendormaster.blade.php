...
<div class="container first">
    <div class="firsthead">
        <div  ><a href="#" class="firsthead1" >Vendor Master</a> </div>
...
<div class="container cont1 ">
    ...
    <a href="{{ url('/download/vendor.xlsx')  }}" target="_blank" class="dawntbutton"><i class="fa-solid fa-download icon"></i>Downlaod</a>
