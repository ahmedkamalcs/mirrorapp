@extends('layouts.app', ['activePage' => 'einvoiceb2c', 'titlePage' => __('E-Invoicecs B2C')])
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        @if(User::isUserCanViewEInvoiceB2C() == '0')
        ...
        @if(User::isUserCanViewEInvoiceB2C() == '1')
          <div class="card-header card-header-primary">
            <h4 class="card-title ">E-Invoices B2C</h4>
            <!--<p class="card-category">Here are your saved e-invoices</p>-->



            <form action="{{url("importb2c")}}" method="post" enctype="multipart/form-data">
                @csrf
                <fieldset>
