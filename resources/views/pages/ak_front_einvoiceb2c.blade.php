...
<div class="container first">
    <div class="firsthead">
        <div  ><a href="#" class="firsthead1" >B2C E-invoice</a> </div>
        <div class="headline3"> </div>
    </div>


<!--    <div >
        <div ><a href="#" class="firsthead2"> Add B2C E-invoice</a></div>
...
<div class="container cont1 ">
    ...
    <div id="uploadform">
        ...
        <form class="uploadFileForm" action="{{url("importb2c")}}" method="post" enctype="multipart/form-data" >
            @csrf
