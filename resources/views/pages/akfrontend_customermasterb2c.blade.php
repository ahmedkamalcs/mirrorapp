@extends('layouts.app', ['activePage' => 'customermasterb2c', 'titlePage' => __('Customer Master B2C')])
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        @if(User::isUserCanViewCustomerMasterB2C() == '0')
        ...
        @if(User::isUserCanViewCustomerMasterB2C() == '1')
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title ">Customer Master</h4>
            <!--<p class="card-category">Here are your saved e-invoices</p>-->

            <form action="{{url("importcustomerb2c")}}" method="post" enctype="multipart/form-data">
                @csrf
                <fieldset>
