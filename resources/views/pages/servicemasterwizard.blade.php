...
<div class="container thierd " >
    <form  class="container thierd " style="outline: none;" action="{{url("saveitemservice")}}" method="post" enctype="multipart/form-data" >
        @csrf
        <div class="container  mb-2">
            <div class="row" >
                <div class="span2">
                    <button type="button" class="btnreset" name="reset"><a href="{{url("servicemaster")}}">Cancel</a></button>
        ...
        <div class="container  mb-2">
            <div class="row ">
                ...
                <div class="col" ><input type="text" name="itemPrice" id="itemPrice" class="form-control input7" placeholder="Service Price"></div>
        ...
        <div class="container  mb-2">
            <div class="row ">
                ...
                <div class="col"><input type="text" name="itemDescription" id="itemDescription" class="form-control input6" placeholder="Service Description"></div>
