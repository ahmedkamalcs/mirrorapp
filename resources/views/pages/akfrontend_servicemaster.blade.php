@extends('layouts.app', ['activePage' => 'servicemaster', 'titlePage' => __('Service Service')])
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        @if(User::isUserCanViewServiceMaster() == '0')
        ...
        @if(User::isUserCanViewServiceMaster() == '1')
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title ">Item Service Master</h4>
            <!--<p class="card-category">Here are your saved e-invoices</p>-->

            <form action="{{url("importitemservice")}}" method="post" enctype="multipart/form-data">
                @csrf
                <fieldset>
