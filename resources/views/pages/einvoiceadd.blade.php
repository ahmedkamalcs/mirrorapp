@extends('layouts.app', ['activePage' => 'einvoiceadd', 'titlePage' => __('E-Invoice Data Entry')])
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
            ...
            @if(User::isUserCanAddEInvoiceB2C() == '0')
            ...
            @if(User::isUserCanAddEInvoiceB2C() == '1')
            ...
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">{{ __('E-Invoice B2C') }}</h4>
                <p class="card-category">{{ __('E-Invoice Details B2C') }}</p>
              </div>
              <div class="card-body ">
                @if (session('status'))
                  <div class="row">
...
<!--                      @if ($errors->has('name'))
                      ...
                      @endif-->
                    <!--<input class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" />-->
<input class="form-control{{ $errors->has('suppliervatno') ? ' is-invalid' : '' }}" value="207" name="invoiceno" id="input-name" type="text" placeholder="{{ __('Invoice NO') }}"  required="true" aria-required="true"/>
                    </div>
                  </div>
                </div>
<!--                <div class="row">
...
<!--                <div class="row">
              ...
              <input type="hidden" id="invoicetype" name="invoicetype" value="b2c">
