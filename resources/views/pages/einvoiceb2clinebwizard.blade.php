...
<div class="container first" >
    <div class="firstheaditemservice">
        <div  class="firsthead1" >B2C Inv Line</div>
...
<div class="container thierd " >
    <form  class="container thierd " style="outline: none;" action="{{url("saveEinvoiceLineB2C")}}" method="post" enctype="multipart/form-data" >
        @csrf
        <div class="container  mb-2">
            <div class="row" >
                <div class="span2">
                    <button type="button" class="btnreset" name="reset"><a href="{{url("b2ceinvoicewizard")}}">Cancel</a></button>
...
<!--                <div class=" firstcol" ><p >Tax Rate</p></div>
                <div class="col" ><input type="text" name="taxRate" id="taxRate" class="form-control input7" placeholder="Tax Rate"></div>-->
