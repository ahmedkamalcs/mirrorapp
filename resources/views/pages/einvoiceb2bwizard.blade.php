...
<div class="container thierd " >
    <form  class="container thierd " style="outline: none;" action="{{url("saveEinvoiceB2B")}}" method="post" enctype="multipart/form-data" >
        @csrf
        <div class="container  mb-2">
            <div class="row" >
                <div class="span2">
                    <button type="button" class="btnreset" name="reset"><a href="{{url("einvoiceb2b")}}">Back</a></button>
        ...
        <div class="container  mb-2">
            <div class="row ">
                ...
                <div class="col" ><input readonly="true" type="text" name="VATNO" value="{{$eInvoiceHeaderDTO->getSupplierVATNO()}}" id="VATNO" class="form-control input7" placeholder="VAT No"></div>
...
<!--        <div class="container  mb-2">
    ...
    <form style="width: 1650px; height: 50px;" action="{{url("b2beinvoicelinewizard")}}" method="get" enctype="multipart/form-data" >
        @csrf
        {{ method_field('PUT') }}
        <div class="container  ">
