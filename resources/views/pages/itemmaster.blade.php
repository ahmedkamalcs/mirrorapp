...
<div class="container first" >
    <div class="firstheaditemservice">
        <div  class="firsthead1">Item Master</div>
...
<div class="container cont1 ">
    <button class="addbutton" disabled="true"><i class="fa-solid fa-plus icon"></i><a href="{{url("itemmasterwizard")}}">Add</a></button>
    ...
    <a href="{{ url('/download/items.xlsx')  }}" target="_blank" class="dawntbutton"><i class="fa-solid fa-download icon"></i>Downlaod</a>
    ...
    <div id="uploadform">
        ...
        <form class="uploadFileForm" action="{{url("importitem")}}" method="post" enctype="multipart/form-data" >
            @csrf
