...
class ItemWebController extends BaseController {
...
//        
        ...
        $itemsArr = $bItemMaster->listItems();

        return view('pages.itemmaster', compact('itemsArr'));
    }
...
//        echo $time; die;
        ...
        $itemMasterDTO->setItemType(AppDTO::$ITEM_TYPE_ITEM);
...
//        
        ...
        return view('pages.itemmasterwizard');
    }
    
    public function saveWizardItemMaster(Request $request) {
        //TODO Validate Here

        $itemMasterDTO = $this->fillinWizardItemMasterDTO($request);
        $this->saveItemMasterByDto($itemMasterDTO);
//        return back()->withSuccess('Service Item is saved successfully!');
        return $this->listItems();
    }

    private function fillinWizardItemMasterDTO(Request $request) {
    ...
    private function saveItemMasterByDto(ItemMasterDTO $itemMasterDTO) {
        $bItemMaster = new BItemMaster();
        $bItemMaster->saveObject($itemMasterDTO);
    }
