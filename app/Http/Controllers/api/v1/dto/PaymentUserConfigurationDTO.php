 ...
 * @author Ahmed Kamal
 */
class PaymentUserConfigurationDTO implements DTOInterface {

    //put your code here

    private $paymentBrandName;
    private $userId;
    ...
    public function getPaymentBrandName() {
        return $this->paymentBrandName;
    }

    public function setPaymentBrandName($paymentBrandName) {
