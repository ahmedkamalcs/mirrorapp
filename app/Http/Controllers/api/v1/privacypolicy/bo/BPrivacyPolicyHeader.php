...
use App\Models\api\v1\privacypolicy\PrivacyPolicyHeaderModel;
use App\Http\Controllers\api\v1\dto\AppDTO;

class BPrivacyPolicyHeader extends Controller implements BusinessInterface {

    public function saveObject(PrivacyPolicyHeaderDTO $privacyPolicyHeaderDTO) {
        $privacyPolicyHeaderModel = new PrivacyPolicyHeaderModel();
        $obj = $privacyPolicyHeaderModel->saveObject($privacyPolicyHeaderDTO);
        if ($obj) {
            if ($privacyPolicyHeaderDTO->getApiCall() == AppDTO::$TRUE_AS_STRING) {
