...
class BPaymentUserInvoice {
    ...
    public function saveObject(PaymentUserInvoiceDTO $userInvoiceDTO) {
        ...
        if ($this->isInvoiceFullyPaid($userInvoiceDTO)) {
            if ($userInvoiceDTO->getApiCall() == AppDTO::$TRUE_AS_STRING) {
        ...
        $userInvoice = new PaymentUserInvoiceModel();
        $userInvoice->saveObject($userInvoiceDTO);
