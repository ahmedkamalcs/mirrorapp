...
use App\Models\api\v1\paymentmodel\PaymentUserConfigurationModel;
...
class BPaymentUserConfiguration {
    ...
    public function saveObject(PaymentUserConfigurationDTO $paymentUserConfigurationDTO) {
        $paymentUserConfiguration = new PaymentUserConfigurationModel();
        $paymentUserConfiguration->saveObject($paymentUserConfigurationDTO);

        if ($paymentUserConfigurationDTO->getApiCall() == AppDTO::$TRUE_AS_STRING) {
