      ...
      <div class="col-md-8 ml-auto mr-auto">
        <div class="card">
          <div class="card-header card-header-primary">
            <h4 class="card-title">E-Invoice System PRO</h4>
            <p class="card-category">Are you looking for more components? Please check our Premium Version of E-Invoice System.</p>
          </div>
          <div class="card-body">
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <a target="_blank" href="https://isglobal.co/product/material-dashboard-pro-laravel" aria-disabled="true" class="btn btn-round btn-fill btn-info">Upgrade to PRO</a>
                    </td>
                  </tr>
                </tbody>
              </table>
